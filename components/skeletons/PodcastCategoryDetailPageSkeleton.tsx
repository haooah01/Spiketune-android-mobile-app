// components/skeletons/PodcastCategoryDetailPageSkeleton.tsx
import React from 'react';
import SkeletonButton from './SkeletonButton';
import SkeletonText from './SkeletonText';
import SkeletonImage from './SkeletonImage';

// Local helper for MediaItemCard-like skeleton (consistent with CategoryDetailPageSkeleton)
...
const PodcastCategoryDetailPageSkeleton: React.FC = () => (
...
export default PodcastCategoryDetailPageSkeleton;
