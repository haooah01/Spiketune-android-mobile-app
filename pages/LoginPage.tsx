...
const LoginPage: React.FC = () => {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      addNotification({ message: err.message || 'Login error.', type: 'error' });
    } finally {
      setIsLoading(false);
    }
  };
    ...
    <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center p-4 select-none">
      ...
      <main className="w-full max-w-md space-y-8 mt-16 sm:mt-20">
        <div className="text-center">
          <h1 className="text-3xl sm:text-4xl font-bold mb-8">Log in to SPIKETUNE</h1>
        </div>
